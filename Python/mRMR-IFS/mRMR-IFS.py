...
num_features_to_select = 5000  # Number of features to select
feature_names = pymrmr.mRMR(train_set_oversampled, 'MIQ', num_features_to_select)
...
# Calculate the average for F1, prc_auc, and roc_auc
