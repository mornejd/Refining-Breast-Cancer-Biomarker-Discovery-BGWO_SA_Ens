PHgenes <- read.table(file = 'C:\\Users\\....\\PHgenes.xls', sep = '\t', header = TRUE)
Sgenes <- read.table(file = 'C:\\Users\\....\\Sgenes.xls', sep = '\t', header = TRUE)
...
write.table(Final, file=paste0("C:\\Users\\....\\DEGs10810_ML Ready.xls"), sep="\t", quote=FALSE)
write.table(UpReg, file=paste0("C:\\Users\\....\\UpReg10810.xls"), sep="\t", quote=FALSE)
write.table(DownReg, file=paste0("C:\\Users\\....\\DownReg10810.xls"), sep="\t", quote=FALSE)
