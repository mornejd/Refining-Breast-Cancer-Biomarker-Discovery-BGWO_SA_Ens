PHgenes <- read.table(file = 'C:\\Users\\....\\PHgenes42568.xls', sep = '\t', header = TRUE)
rownames(PHgenes) <- PHgenes$X
PHgenes <-  subset(PHgenes, select=-c(X))
Sgenes <- read.table(file = 'C:\\Users\\....\\Sgenes42568.xls', sep = '\t', header = TRUE)
...
write.table(Final, file=paste0("C:\\Users\\....\\DEGs42568_ML Ready.xls"), sep="\t", quote=FALSE)
write.table(UpReg, file=paste0("C:\\Users\\....\\UpReg42568.xls"), sep="\t", quote=FALSE)
write.table(DownReg, file=paste0("C:\\Users\\....\\DownReg42568.xls"), sep="\t", quote=FALSE)
...
write.table(ML, file=paste0("C:\\Users\\....\\AllGenes_ML Ready.xls"), sep="\t", quote=FALSE)
