Sgenes42568 <- read.table("C:\\Users\\....\\Sgenes42568.xls", sep="\t", header=TRUE, row.names=1)
PHgenes42568 <- read.table("C:\\Users\\....\\PHgenes42568.xls", sep="\t", header=TRUE, row.names=1)

Sgenes10810 <- read.table("C:\\Users\\....\\Sgenes10810.xls", sep="\t", header=TRUE, row.names=1)
PHgenes10810 <- read.table("C:\\Users\\....\\PHgenes10810.xls", sep="\t", header=TRUE, row.names=1)

PHgenes <- rbind(PHgenes10810, PHgenes42568)
write.table(PHgenes, file=paste0("C:\\Users\\....\\PHgenes.xls"), sep="\t", quote=FALSE)


dfs_list <- list(Sgenes10810, Sgenes42568)
# Updated merging function to remove 'Row.names' column after each merge
Sgenes <- Reduce(function(x, y) {
